...
//	CatDto 클래스 타입의 변수 cal에 사용자가 입력한 데이터가 저장되어 서버로 전송됨
	...
	@RequestMapping("/ajax/ajaxCalculator.do")
	public String ajaxCalculator() throws Exception {
		return "/ajax/Calculator";
	}
	
	@ResponseBody
	@RequestMapping(value="/ajax/CalSum", method=RequestMethod.POST)
	public Object ajaxCalculatorSum(CalDto cal) throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
		
		result.put("num1", cal.getNum1());
		result.put("num2", cal.getNum2());
		result.put("result", cal.getNum1() + cal.getNum2());
		
		return result;
	}
	
	@ResponseBody
	@RequestMapping(value="/ajax/CalSub", method=RequestMethod.POST)
	public Object ajaxCalculatorSub(CalDto cal) throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
	...
	@ResponseBody
	@RequestMapping(value="/ajax/CalMulti", method=RequestMethod.POST)
	public Object ajaxCalculatorMulti(CalDto cal) throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
	...
	@ResponseBody
	@RequestMapping(value="/ajax/CalDiv", method=RequestMethod.POST)
	public Object ajaxCalculatorDiv(CalDto cal) throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
